...
<br>
      <h1 class="titlebar" aria-label="<?php echo e(trim($brandTxt.' รุ่น • '.($moTxt ?: $modelTxt ?: ''))); ?>">
        <span class="brand"><?php echo e($brandTxt ?: '—'); ?></span>
        <?php if($moTxt || $modelTxt): ?>
          <span class="model"><span class="prefix">รุ่น •</span> <span class="tabnums"><?php echo e($moTxt ?: $modelTxt); ?></span></span>
        <?php endif; ?>
      </h1>

<?php if($subline !== ''): ?>
  <p class="subline mt-1 text-slate-900">  
    <?php echo e($subline); ?><?php if($skuTxt): ?> • SKU: <?php echo e($skuTxt); ?> <?php endif; ?>
  </p>
<?php endif; ?>
        ...
        <div class="soft rounded-2xl bg-white px-5 md:px-6 py-6 md:py-7 h-full flex flex-col">
          <figure class="flex-1 flex flex-col items-center justify-center">
            <div class="product-box">
              <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($titleLine ?: $nameTxt); ?>" width="225" height="225"
          ...
          <div class="sticky-buy soft rounded-2xl glass p-5 md:p-6 border border-white/40 h-full flex flex-col">
            ...
            <div class="flex flex-wrap items-center gap-2">
              <span class="badge bg-amber-50 text-amber-700 border-amber-200">
                ...
                <span>จัดส่ง: <strong><?php echo e($leadTxt); ?></strong></span>
              </span>
              <?php
              ...
              ?>
              <span class="badge <?php echo e($stockBadgeClass); ?>">
                <i class="bi bi-box-seam"></i>
                <span>สต็อก: <strong class="tabnums"><?php echo e($stockTxt); ?></strong></span>
              </span>
            </div>
            ...
            <div class="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <a href="tel:<?php echo e($tel); ?>" class="btn inline-flex items-center justify-center gap-2 px-4 py-3 font-semibold soft bg-slate-900 text-white hover:bg-slate-800" aria-label="โทรหาเรา">
