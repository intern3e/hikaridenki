    ...
    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <details class="border border-slate-200 rounded-xl p-3 group mb-2">
            ...
            <ul class="mt-3 space-y-2">
                <?php $__currentLoopData = $services[$cat] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <details class="border rounded p-2 bg-slate-100">
                            <summary class="cursor-pointer font-medium"><?php echo e($brand); ?></summary>
                                ...
                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <button type="button"
                                                ...
                                                onclick="showPDF(`<?php echo e(asset('storage/' . $service->pdf)); ?>`)"
                                                title="<?php echo e($service->name_brochure); ?>">
                                            <?php echo e($service->name_brochure); ?>
