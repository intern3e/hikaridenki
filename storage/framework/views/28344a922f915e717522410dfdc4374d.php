  ...
  <header class="sticky top-0 z-50 transition-all bg-white" role="banner">
    <div class="max-w-7xl mx-auto flex items-center justify-between py-3.5 px-4 md:px-6">
      ...
      <a href="/" class="flex items-center gap-2">
        <img src="<?php echo e(asset('storage/logo/PNG.png')); ?>" alt="PowerCare logo"
  ...
  <aside id="drawerPanel" class="md:hidden" role="dialog" aria-modal="true" aria-label="เมนูนำทางมือถือ">
    ...
    <div class="flex items-center justify-between px-4 py-3 border-b">
      <div class="flex items-center gap-2">
        <img src="<?php echo e(asset('storage/logo/PNG.png')); ?>" alt="PowerCare" class="w-7 h-7 object-contain">
    ...
    <nav class="flex-1 overflow-y-auto p-4 space-y-4" id="mobile-accordion">
          ...
          <div class="grid grid-rows-[0fr] group-open:grid-rows-[1fr] transition-[grid-template-rows] duration-300">
            <div class="overflow-hidden">
              <ul class="mt-3 grid grid-cols-2 gap-3 text-sm">
                <li class="min-w-0"><button class="<?php echo e($chipBox); ?>" onclick="showPDF('<?php echo e(asset('storage/UPS/APC/APC Easy UPS Single Phase Family Brochure.pdf')); ?>')"><span class="truncate">APC</span></button></li>
                <li class="min-w-0"><button class="<?php echo e($chipBox); ?>" onclick="showPDF('<?php echo e(asset('storage/UPS/CyberPower/CyberPower_CL_UPS-2016.pdf')); ?>')"><span class="truncate">CyberPower</span></button></li>
                <li class="min-w-0"><button class="<?php echo e($chipBox); ?>" onclick="showPDF('<?php echo e(asset('storage/UPS/Delta/Delta-UPS-en-us.pdf')); ?>')"><span class="truncate">Delta</span></button></li>
                <li class="min-w-0"><button class="<?php echo e($chipBox); ?>" onclick="showPDF('<?php echo e(asset('storage/UPS/Eaton/eaton_ups_product_catalogue_en-gb-anz.pdf')); ?>')"><span class="truncate">Eaton</span></button></li>
                <li class="min-w-0"><button class="<?php echo e($chipBox); ?>" onclick="showPDF('<?php echo e(asset('storage/UPS/Vertiv/Vertiv-ups-catalogue-en.pdf')); ?>')"><span class="truncate">Vertiv</span></button></li>
              </ul>
            </div>
          </div>
        </details>
      ...
      <section class="rounded-2xl border border-slate-200 bg-white/80 backdrop-blur p-4">
        ...
        <div class="grid grid-rows-[0fr] group-open:grid-rows-[1fr] transition-[grid-template-rows] duration-300">
          <div class="overflow-hidden">
            <ul class="mt-3 grid grid-cols-2 gap-3 text-sm">
              <li class="min-w-0"><button class="<?php echo e($chipBox); ?>" onclick="showPDF('<?php echo e(asset('storage/Emergency/Dyno/Dyno ไฟฉุกเฉิน Cover-front.pdf')); ?>')"><span class="truncate">Dyno</span></button></li>
              <li class="min-w-0"><button class="<?php echo e($chipBox); ?>" onclick="showPDF('<?php echo e(asset('storage/Emergency/Maxbright/MaxBright  ไฟฉุกเฉิน.pdf')); ?>')"><span class="truncate">Maxbright</span></button></li>
              <li class="col-span-2 min-w-0"><button class="<?php echo e($chipBox); ?>" onclick="showPDF('<?php echo e(asset('storage/Emergency/Sunny/Sunny-Catalog_2024.pdf')); ?>')"><span class="truncate">Sunny</span></button></li>
            </ul>
          </div>
        </div>
        </details>
                ...
                <div class="grid grid-rows-[0fr] group-open:grid-rows-[1fr] transition-[grid-template-rows] duration-300">
                  <div class="overflow-hidden">
                    <ul class="mt-3 grid grid-cols-1 gap-3 text-sm">
                      <li class="min-w-0">
                        <button class="<?php echo e($chipBox); ?> h-auto min-h-10 py-2 px-3 justify-start text-left whitespace-normal break-words"
                                onclick="showPDF('<?php echo e(asset('storage/Battery/Leoch Battery/Leoch LHR Series ups.pdf')); ?>')">
                          <span class="leading-snug">Leoch LHR Series ups</span>
                        </button>
                      </li>
                      <li class="min-w-0">
                        <button class="<?php echo e($chipBox); ?> h-auto min-h-10 py-2 px-3 justify-start text-left whitespace-normal break-words"
                                onclick="showPDF('<?php echo e(asset('storage/Battery/Leoch Battery/Leoch LP Series Battery.pdf')); ?>')">
                          <span class="leading-snug">Leoch LP Series Battery</span>
                        </button>
                      </li>
                      <li class="min-w-0">
                        <button class="<?php echo e($chipBox); ?> h-auto min-h-10 py-2 px-3 justify-start text-left whitespace-normal break-words"
                                onclick="showPDF('<?php echo e(asset('storage/Battery/Leoch Battery/Leoch XP -series-sheet_july-2024.pdf')); ?>')">
                ...
                <div class="grid grid-rows-[0fr] group-open:grid-rows-[1fr] transition-[grid-template-rows] duration-300">
                  <div class="overflow-hidden">
                    <ul class="mt-3 grid grid-cols-1 gap-3 text-sm">
                      <li class="min-w-0">
                        <button class="<?php echo e($chipBox); ?> h-auto min-h-10 py-2 px-3 justify-start text-left whitespace-normal break-words"
                                onclick="showPDF('<?php echo e(asset('storage/Battery/Long Battery/Long IDCUPS_Batteries.pdf')); ?>')">
                          <span class="leading-snug">Long IDCUPS_Batteries</span>
                        </button>
                      </li>
                      <li class="min-w-0">
                        <button class="<?php echo e($chipBox); ?> h-auto min-h-10 py-2 px-3 justify-start text-left whitespace-normal break-words"
                                onclick="showPDF('<?php echo e(asset('storage/Battery/Long Battery/Long Sealed_Lead_Acid_Batteries.pdf')); ?>')">
...
<div class="rounded-2xl border border-slate-200 bg-white/70 p-4 mt-4">
  ...
  <details class="border border-slate-200 rounded-xl p-3 group">
    ...
    <ul class="mt-3 grid grid-cols-2 gap-3 text-sm">
      <li class="min-w-0">
        <button type="button" class="<?php echo e($chipBox); ?>"
          onclick="showPDF(`<?php echo e(asset('storage/UPS/APC/APC Easy UPS Single Phase Family Brochure.pdf')); ?>`)"
          title="APC"><span class="truncate">APC</span></button>
      </li>
      <li class="min-w-0">
        <button type="button" class="<?php echo e($chipBox); ?>"
          onclick="showPDF(`<?php echo e(asset('storage/UPS/CyberPower/CyberPower_CL_UPS-2016.pdf')); ?>`)"
          title="CyberPower"><span class="truncate">CyberPower</span></button>
      </li>
      <li class="min-w-0">
        <button type="button" class="<?php echo e($chipBox); ?>"
          onclick="showPDF(`<?php echo e(asset('storage/UPS/Delta/Delta-UPS-en-us.pdf')); ?>`)"
          title="Delta"><span class="truncate">Delta</span></button>
      </li>
      <li class="min-w-0">
        <button type="button" class="<?php echo e($chipBox); ?>"
          onclick="showPDF(`<?php echo e(asset('storage/UPS/Eaton/eaton_ups_product_catalogue_en-gb-anz.pdf')); ?>`)"
          title="Eaton"><span class="truncate">Eaton</span></button>
      </li>
      <li class="min-w-0">
        <button type="button" class="<?php echo e($chipBox); ?>"
          onclick="showPDF(`<?php echo e(asset('storage/UPS/Vertiv/Vertiv-ups-catalogue-en.pdf')); ?>`)"
...
<div class="rounded-2xl border border-slate-200 bg-white/70 p-4 mt-4">
  ...
  <details class="border border-slate-200 rounded-xl p-3 group">
    ...
    <ul class="mt-3 grid grid-cols-2 gap-3 text-sm">
      <li class="min-w-0">
        <button type="button" class="<?php echo e($chipBox); ?>"
          onclick="showPDF(`<?php echo e(asset('storage/Emergency/Dyno/Dyno ไฟฉุกเฉิน Cover-front.pdf')); ?>`)"
          title="Dyno"><span class="truncate">Dyno</span></button>
      </li>
      <li class="min-w-0">
        <button type="button" class="<?php echo e($chipBox); ?>"
          onclick="showPDF(`<?php echo e(asset('storage/Emergency/Maxbright/MaxBright  ไฟฉุกเฉิน.pdf')); ?>`)"
          title="Maxbright"><span class="truncate">Maxbright</span></button>
      </li>
      <li class="col-span-2 min-w-0">
        <button type="button" class="<?php echo e($chipBox); ?>"
          onclick="showPDF(`<?php echo e(asset('storage/Emergency/Sunny/Sunny-Catalog_2024.pdf')); ?>`)"
    ...
    <div class="mt-3 space-y-3 text-sm">
      ...
      <details class="border border-slate-200 rounded-lg p-3 group">
        ...
        <ul class="mt-2 grid grid-cols-1 gap-3">
          <li class="min-w-0">
            <button type="button"
              class="<?php echo e($chipBox); ?> h-auto min-h-10 py-2 px-3 justify-start text-left whitespace-normal break-words"
              onclick="showPDF(`<?php echo e(asset('storage/Battery/Leoch Battery/Leoch LHR Series ups.pdf')); ?>`)"
 ...
 <!-- Footer -->
  ...
  <div id="floating-buttons" aria-label="Quick actions">
    <a class="fb-circle fb-line" aria-label="LINE" href="line://ti/p/@543ubjtx" title="Chat on LINE">
      <img src="<?php echo e(asset('storage/line.avif')); ?>" alt="LINE">
    </a>
  ...
  (function(){
    ...
    document.addEventListener("DOMContentLoaded", function(){
      showPDF("<?php echo e(asset('storage/k.pdf')); ?>");
    });
  })();
  </script>
...
<?php /**PATH C:\xampp\htdocs\hikaridenki\resources\views/Product.blade.php ENDPATH**/ ?>