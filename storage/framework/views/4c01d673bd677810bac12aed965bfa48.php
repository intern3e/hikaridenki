...
<body>
        ...
        <div class="grid gap-3 md:grid-cols-[minmax(0,1fr)_auto_auto] md:items-center">
          ...
          <div class="hidden md:block">
            <form method="GET" data-seg-sort>
              <?php $__currentLoopData = ['brand','in_stock','view','q','category','catagory']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <aside class="hidden md:block md:sticky md:top-20 self-start" aria-label="ตัวกรองสินค้า">
        <div class="bg-white border rounded-xl soft overflow-hidden">
          ...
          <nav class="max-h-[70vh] overflow-y-auto no-scrollbar py-2" aria-label="กรองตามยี่ห้อ">
            <a href="<?php echo e($withQS(route('showproduct'))); ?>"
  ...
  <div class="img-rail relative">
    ...
    <?php if(!empty($item->brand)): ?>
      <span class="absolute left-2 bottom-2 inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs bg-sky-50 text-sky-700 ring-1 ring-sky-200">
        <i class="bi bi-building"></i><?php echo e($item->brand); ?>
  ...
  <div class="p-3 sm:p-4 flex-1 flex flex-col">
    ...
    <?php if($hasPrice): ?>
      <div class="font-bold text-amber-600 mb-3"><?php echo e(e($rawPrice)); ?> ฿</div>
    <?php else: ?>
      <div class="font-semibold text-slate-600 mb-3">สอบถามเพิ่มเติม</div>
    <?php endif; ?>

    <div class="chips mb-3">
      <span class="chip <?php echo e($leadChip); ?>"><i class="bi bi-truck"></i><span class="label">ส่ง:</span><strong class="value"><?php echo e($leadTxt); ?></strong></span>
      <span class="chip <?php echo e($stockChip); ?>"><i class="bi bi-box-seam"></i><span class="label">คงเหลือ:</span><strong class="value"><?php echo e($stockTxt); ?></strong></span>
    </div>
