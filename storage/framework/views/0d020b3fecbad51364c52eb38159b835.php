  ...
  <header class="sticky top-0 z-50 transition-all bg-white shadow" role="banner">
    <div class="max-w-7xl mx-auto flex items-center justify-between py-3.5 px-4 md:px-6">
      ...
      <a href="Hikari" class="flex items-center gap-2">
        <img src="<?php echo e(asset('storage/logo/Gemini_Generated_Image_44k6m544k6m544k6.png')); ?>" alt="PowerCare logo"
...
<aside class="bg-white rounded-xl shadow p-4 md:sticky md:top-20 h-max text-[#0b2a6b]">
  ...
  <div class="md:hidden">
    <details class="border-b py-2">
      ...
      <ul class="list-none mt-2 space-y-2 text-sm">
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/UPS/APC/APC Easy UPS Single Phase Family Brochure.pdf')); ?>')">APC</button></li>
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/UPS/CyberPower/CyberPower_CL_UPS-2016.pdf')); ?>')">CyberPower</button></li>
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/UPS/Delta/Delta-UPS-en-us.pdf')); ?>')">Delta</button></li>
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/UPS/Eaton/eaton_ups_product_catalogue_en-gb-anz.pdf')); ?>')">Eaton</button></li>
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/UPS/Vertiv/Vertiv-ups-catalogue-en.pdf')); ?>')">Vertiv</button></li>
      </ul>
    </details>
    ...
    <details class="border-b py-2">
      ...
      <ul class="list-none mt-2 space-y-2 text-sm">
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/Emergency/Dyno/Dyno ไฟฉุกเฉิน Cover-front.pdf')); ?>')">Dyno</button></li>
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/Emergency/Maxbright/MaxBright  ไฟฉุกเฉิน.pdf')); ?>')">Maxbright</button></li>
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/Emergency/Sunny/Sunny-Catalog_2024.pdf')); ?>')">Sunny</button></li>
      </ul>
    </details>
    ...
    <details class="py-2">
      ...
      <ul class="list-none mt-2 space-y-2 text-sm">
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/Battery/Leoch Battery/Leoch LHR Series ups.pdf')); ?>')">Leoch LHR Series ups</button></li>
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/Battery/Leoch Battery/Leoch LP Series Battery.pdf')); ?>')">Leoch LP Series Battery</button></li>
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/Battery/Leoch Battery/Leoch XP -series-sheet_july-2024.pdf')); ?>')">Leoch XP -series</button></li>
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/Battery/Long Battery/Long IDCUPS_Batteries.pdf')); ?>')">Long IDCUPS_Batteries</button></li>
        <li><button class="block w-full text-left py-2 px-3 rounded hover:bg-blue-50"
          onclick="showPDF('<?php echo e(asset('storage/Battery/Long Battery/Long Sealed_Lead_Acid_Batteries.pdf')); ?>')">Long Sealed_Lead_Acid</button></li>
      </ul>
    </details>
  </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Hikari/resources/views/Product.blade.php ENDPATH**/ ?>