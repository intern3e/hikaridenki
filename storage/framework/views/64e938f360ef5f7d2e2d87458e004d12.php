...
<div class="mt-12 grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
  ...
  <article class="partner-card accent-emerald" aria-labelledby="ups-heading">
    ...
    <div class="flex flex-col gap-3">
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/apc.png')); ?>" alt="APC — พันธมิตร UPS" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/cyberpower-seeklogo.png')); ?>" alt="CyberPower — พันธมิตร UPS" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/delta-electronics-seeklogo.png')); ?>" alt="Delta — พันธมิตร UPS" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/eaton-seeklogo.png')); ?>" alt="Eaton — พันธมิตร UPS" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/schneider.png')); ?>" alt="Schneider — พันธมิตร UPS" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/vertiv-seeklogo.png')); ?>" alt="Vertiv — พันธมิตร UPS" loading="lazy" decoding="async">
      </div>
    </div>
  </article>
  ...
  <article class="partner-card accent-blue" aria-labelledby="battery-heading">
    ...
    <div class="flex flex-col gap-3">
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/666_0.png')); ?>" alt="Long — พันธมิตรแบตเตอรี่" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/Accu.png')); ?>" alt="Accu — พันธมิตรแบตเตอรี่" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/csb-battery-seeklogo.png')); ?>" alt="CSB — พันธมิตรแบตเตอรี่" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/Leoch Battery.png')); ?>" alt="Leoch — พันธมิตรแบตเตอรี่" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/panasonic-seeklogo.png')); ?>" alt="Panasonic — พันธมิตรแบตเตอรี่" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/yuasa-seeklogo.png')); ?>" alt="Yuasa — พันธมิตรแบตเตอรี่" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/cyberpower-seeklogo.png')); ?>" alt="CyberPower — พันธมิตรแบตเตอรี่" loading="lazy" decoding="async">
      </div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/eaton-seeklogo.png')); ?>" alt="Eaton — พันธมิตรแบตเตอรี่" loading="lazy" decoding="async">
      </div>
    </div>
  </article>
  ...
  <article class="partner-card accent-amber" aria-labelledby="emg-heading">
    ...
    <div class="flex flex-col gap-3">
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm"><img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/111_0.png')); ?>" alt="Sunny" loading="lazy" decoding="async"></div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm"><img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/222_0.png')); ?>" alt="Iwachi" loading="lazy" decoding="async"></div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm"><img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/333_0.png')); ?>" alt="BEC" loading="lazy" decoding="async"></div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm"><img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/444_0.png')); ?>" alt="Delight" loading="lazy" decoding="async"></div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm"><img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/555_0.png')); ?>" alt="Dyno" loading="lazy" decoding="async"></div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm"><img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/888_0.png')); ?>" alt="Safeguard" loading="lazy" decoding="async"></div>
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm"><img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/MAXBRIGHT.png')); ?>" alt="Max Bright" loading="lazy" decoding="async"></div>
    </div>
  </article>
  ...
  <article class="partner-card accent-red" aria-labelledby="fa-heading">
    ...
    <div class="flex flex-col gap-3">
      <div class="flex items-center justify-center h-24 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <img class="max-h-16 w-auto object-contain select-none pointer-events-none" src="<?php echo e(asset('storage/logo/notifier-seeklogo.png')); ?>" alt="Notifier — พันธมิตรระบบแจ้งเหตุเพลิงไหม้" loading="lazy" decoding="async">
      </div>
    </div>
  </article>
</div>
    ...
    <div class="grid gap-y-6 sm:gap-y-8 gap-x-8 lg:gap-x-12 xl:gap-x-16 grid-cols-1 sm:grid-cols-2 md:grid-cols-12 items-start">
      <section class="order-1 md:order-none w-full md:col-span-3 p-4 sm:p-5 md:p-0 bg-white/5 md:bg-transparent ring-1 ring-white/10 md:ring-0 rounded-xl" aria-labelledby="ft-brand">
        <div class="flex items-center gap-3">
          <img src="<?php echo e(asset('storage/logo/PNG.png')); ?>" alt="PowerCare" class="w-10 h-10 object-contain drop-shadow-md" loading="lazy" decoding="async">
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 py-5 sm:py-6 text-[12px] sm:text-xs text-white/80">
      <nav aria-label="Legal" class="flex flex-col items-center gap-2 sm:gap-3">
        <div class="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
          <span>© <?php echo e(date('Y')); ?> PowerCare by Hikari</span>
...
<?php /**PATH C:\xampp\htdocs\hikaridenki\resources\views/Hikari.blade.php ENDPATH**/ ?>