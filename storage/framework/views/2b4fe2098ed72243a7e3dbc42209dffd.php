...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo e(asset('storage/logo/Gemini_Generated_Image_44k6m544k6m544k6.png')); ?>">
  ...
  <header class="sticky top-0 z-50 transition-all bg-white shadow" role="banner">
    <div class="max-w-7xl mx-auto flex items-center justify-between py-3.5 px-4 md:px-6">
      ...
      <a href="/" class="flex items-center gap-2">
        <img src="<?php echo e(asset('storage/logo/Gemini_Generated_Image_44k6m544k6m544k6.png')); ?>"
             alt="PowerCare logo"
  ...
  <main id="main" tabindex="-1">
    ...
    <section class="relative overflow-hidden" aria-label="ภาพพื้นหลังขนาดจริง">
      <figure class="relative m-0">
        <img src="<?php echo e(asset('storage/logo/20.png')); ?>" alt="PowerCare hero" class="block max-w-full h-auto w-full" loading="eager" decoding="async" fetchpriority="high">
        ...
        <div class="grid md:grid-cols-3 gap-10">
          ...
          <section class="bg-gray-50 rounded-2xl p-8 border-l-4 border-emerald-600 soft text-left reveal">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6 place-items-center">
              <img src="<?php echo e(asset('storage/logo/apc.png')); ?>" alt="APC" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/cyberpower-seeklogo.png')); ?>" alt="CyberPower" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/delta-electronics-seeklogo.png')); ?>" alt="Delta" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/eaton-seeklogo.png')); ?>" alt="Eaton" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/schneider.png')); ?>" alt="Schneider" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/vertiv-seeklogo.png')); ?>" alt="Vertiv" class="h-20 object-contain">
            </div>
          </section>
          ...
          <section class="bg-gray-50 rounded-2xl p-8 border-l-4 border-blue-600 soft text-left reveal">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6 place-items-center">
              <img src="<?php echo e(asset('storage/logo/666_0.png')); ?>" alt="Long" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/Accu.png')); ?>" alt="Accu" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/csb-battery-seeklogo.png')); ?>" alt="CSB" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/Global Power45.png')); ?>" alt="Global Power" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/Leoch Battery.png')); ?>" alt="Leoch" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/panasonic-seeklogo.png')); ?>" alt="Panasonic" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/yuasa-seeklogo.png')); ?>" alt="Yuasa" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/apc.png')); ?>" alt="APC" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/cyberpower-seeklogo.png')); ?>" alt="CyberPower" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/eaton-seeklogo.png')); ?>" alt="Eaton" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/vertiv-seeklogo.png')); ?>" alt="Vertiv" class="h-20 object-contain">
          ...
          <section class="bg-gray-50 rounded-2xl p-8 border-l-4 border-amber-500 soft text-left reveal">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6 place-items-center">
              <img src="<?php echo e(asset('storage/logo/111_0.png')); ?>" alt="Sunny" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/222_0.png')); ?>" alt="Iwachi" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/333_0.png')); ?>" alt="BEC" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/444_0.png')); ?>" alt="Delight" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/555_0.png')); ?>" alt="Dyno" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/888_0.png')); ?>" alt="Safeguard" class="h-20 object-contain">
              <img src="<?php echo e(asset('storage/logo/MAXBRIGHT.png')); ?>" alt="Max Bright" class="h-20 object-contain">
            </div>
          </section>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Hikari/resources/views/Hikari.blade.php ENDPATH**/ ?>